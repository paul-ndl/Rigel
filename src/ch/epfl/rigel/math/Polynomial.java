...
public final class Polynomial {
     ...
     *
     * @param coefficientN le coefficient de plus grand degré
     * @param coefficients la liste des autres coefficients
     */
     ...
     * @param coefficientN le coefficient de plus grand degré
     * @param coefficients la liste des autres coefficients
     * @throws IllegalArgumentException si le coefficient de plus grand degré est nul
     */
