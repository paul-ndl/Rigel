...
public enum Epoch {
    ...
    private final static double MILLIS_IN_DAY = 86400000;
    private final static double MILLIS_IN_CENTURY = 3.15576e12;

    /**
     * Construit une époque à partir d'un couple heure/date donné
     *
     * @param epoch le couple heure/date
     */
    ...
    public double daysUntil(ZonedDateTime when) {
        return (double) epoch.until(when, ChronoUnit.MILLIS) / MILLIS_IN_DAY;
    }
    ...
    public double julianCenturiesUntil(ZonedDateTime when) {
        return (double) epoch.until(when, ChronoUnit.MILLIS) / MILLIS_IN_CENTURY;
    }
